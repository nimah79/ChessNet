...
public class Window extends Group {
	...
	public Window(int i) {
		// Make a new Rectangle and Translate, add the Translate to the
		// Rectangle, add the Rectagle to the Group
		pos = new Translate();
		r = new Rectangle();
	...
	public void resize(double width, double height) {
		// call the super class method and update the height and the width of
		// the rectangle representing the window
